...
//    }
    ...
    func updateTextViewHeight() {
        ...
        //EDITED
        //SELF. interfaceOrientation was deprecated in iOS 8.0
        let maxHeight = UIInterfaceOrientationIsPortrait(UIApplication.sharedApplication().statusBarOrientation) ? ChatViewController.textViewMaxHeight.portrait : ChatViewController.textViewMaxHeight.landscape
